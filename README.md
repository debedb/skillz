...
| [weighted-split-weight-vs-pod-capacity](./skills/weighted-split-weight-vs-pod-capacity/SKILL.md) | skill | Claude, Codex | Weighted ALB target-group split routes correctly but the weight does not match pod capacity: p99 regression, per-pod imbalance, canary HPA pinned |
